...
class TimeCapsule:
    ...
    def __init__(self):
        # Set basic variables
        self.config_file = pkgutil.get_data(__name__,'booknote/config/config.json')
        self.style_file  = pkgutil.get_data('booknote/config/style.json')
        self.kindle_log  =  pkgutil.get_data('booknote/config/kindle.log')
